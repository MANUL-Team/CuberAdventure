        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    Vector4[] sourceUv0 = textInfo.meshInfo[i].uvs0;
                    Vector2[] meshUv = new Vector2[sourceUv0.Length];
                    for (int uvIndex = 0; uvIndex < sourceUv0.Length; uvIndex++)
                        meshUv[uvIndex] = new Vector2(sourceUv0[uvIndex].x, sourceUv0[uvIndex].y);
                    textInfo.meshInfo[i].mesh.uv = meshUv;
